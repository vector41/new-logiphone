...
public class WarningDialong extends Dialog implements View.OnClickListener {
    private String content;

    public WarningDialong(Activity activity, String content) {
        super(activity);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modal_warning);
