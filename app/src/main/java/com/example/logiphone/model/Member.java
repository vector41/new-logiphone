...
public class Member {
    ...
    public Member(int id, String person_name_second, String person_name_first, String person_name_second_kana, String person_name_first_kana, int gender, String source, int type) {
        this.id = id;
