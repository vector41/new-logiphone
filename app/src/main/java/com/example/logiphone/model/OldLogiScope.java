...
public class OldLogiScope {
    ...
    public OldLogiScope(int id, String person_name_second, String person_name_first, String person_name_second_kana, String person_name_first_kana, String tel1, String tel2, String tel3, int gender, int type) {
        this.id = id;
